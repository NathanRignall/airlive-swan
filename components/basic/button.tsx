...
const VARIANT_MAPS: Record<Variant, string> = {
  [Variant.LOGOLIGHT]: "bg-logo-light text-white",
  [Variant.LOGOMAIN]: "bg-logo-main text-white",
  [Variant.LOGODARK]: "bg-logo-dark text-white",
  ...
  return (
    <div
      className={classNames(
        "items-center flex justify-center rounded-md mb-2",
